...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/pf/rosWS/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/pf/rosWS/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/pf/rosWS/install)
...
if(NOT "/home/pf/rosWS/devel/include;/home/pf/rosWS/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/pf/rosWS/devel/include;/home/pf/rosWS/src/navigation/navfn/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pf/rosWS/src/navigation/navfn/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
