...
echo_and_run cd "/home/pf/rosWS/src/rqt_common_plugins/rqt_logger_level"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/pf/rosWS/src/rqt_common_plugins/rqt_logger_level/setup.py" \
    build --build-base "/home/pf/rosWS/build/rqt_common_plugins/rqt_logger_level" \
    install \
    $DESTDIR_ARG \
