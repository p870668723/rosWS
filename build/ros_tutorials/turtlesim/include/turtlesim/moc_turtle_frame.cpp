...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_turtlesim__TurtleFrame_t, stringdata) + ofs \
...
const QMetaObject turtlesim::TurtleFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_turtlesim__TurtleFrame.data,
      qt_meta_data_turtlesim__TurtleFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_turtlesim__TurtleFrame.stringdata))
